...
const workflowStages = [
  ...
  { id: "review", label: "Review Sources", status: "completed" as const, href: "/superhero/reviewer" },
  ...
  return (
    <div className="min-h-screen bg-[#0d1117] flex flex-col">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-xl border border-[#30363d] bg-[#0d1117] p-4">
                  ...
                  <div className="space-y-2">
                    <Link href="/superhero/coordinator" className="block text-xs text-[#8b949e] hover:text-[#f0f6fc]">← Back to owner assignments</Link>
      ...
      <StakeholderFooter label={submitted ? "Continue as General Counsel to advance the workflow" : "Submit your investigation above to continue"}>
        ...
        {submitted && (
          <PrototypeControlLink href="/superhero/writer">
