    ...
    <div className="min-h-screen bg-[#0d1117] pb-28">
      ...
      <div className="rounded-3xl border border-[#30363d] bg-[#161b22] shadow-sm overflow-hidden">
        <div className="px-6">
            ...
            <div className="mx-auto flex w-full max-w-6xl items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <span className="rounded-full border border-[#30363d] bg-[#21262d] px-2 py-0.5 text-xs text-[#8b949e]">({ACTIVITY_LOG.length})</span>
                </button>
            ...
            <div className="-mt-4 mb-6">
              <Card className="p-4">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <button className="rounded-lg border border-[#30363d] bg-[#161b22] px-2 py-1 text-xs text-[#8b949e] hover:bg-[#21262d] hover:text-[#f0f6fc]" onClick={() => setActivityOpen(false)}>Close</button>
                </div>
          ...
          <header className="rounded-3xl border border-[#58a6ff]/40 bg-gradient-to-br from-[#58a6ff]/10 to-[#0d1117] p-10 shadow-sm">
            ...
            <div className="mt-6 flex justify-center gap-4">
              <div className="rounded-xl border border-[#da3633]/40 bg-[#da3633]/10 px-4 py-2 text-center">
                ...
                <p className="text-xs text-[#8b949e]">Critical</p>
              </div>
              <div className="rounded-xl border border-[#d29922]/40 bg-[#d29922]/10 px-4 py-2 text-center">
                <p className="text-2xl font-semibold text-[#d29922]">2</p>
                <p className="text-xs text-[#8b949e]">High</p>
              </div>
              <div className="rounded-xl border border-[#58a6ff]/40 bg-[#58a6ff]/10 px-4 py-2 text-center">
                <p className="text-2xl font-semibold text-[#58a6ff]">3</p>
                <p className="text-xs text-[#8b949e]">Filings Affected</p>
              </div>
            </div>
                ...
                {WORKFLOW_STAGES.map((stage, idx) => (
                  <React.Fragment key={stage.id}>
                    <div className={cn(
                      ...
                      stage.status === "current" && "bg-[#58a6ff]/20 text-[#58a6ff] ring-2 ring-[#58a6ff]/50",
          ...
          {/* Agent ticker */}
          <div className="rounded-2xl border border-[#30363d] bg-[#21262d] px-4 py-2 mt-4">
            <div className="flex items-center gap-3">
              <span className="shrink-0 text-xs font-medium uppercase tracking-[0.2em] text-[#6e7681]">Legal Monitoring Agents</span>
              <div className="flex-1">
                <div className="flex items-center gap-6 overflow-x-auto">
                  {AGENTS.map((agent) => (
                    <span key={agent.name} className="whitespace-nowrap text-sm text-[#8b949e]">
          ...
          <section className="mt-8">
            <Card className="p-0 overflow-hidden">
              <div className="flex items-center justify-between px-5 py-3 border-b border-[#30363d]">
                <div className="flex items-center gap-3">
                  <h2 className="text-sm font-semibold text-[#f0f6fc]">Risks Under Review</h2>
                  <span className="rounded-full border border-[#58a6ff]/40 bg-[#58a6ff]/10 px-2 py-0.5 text-xs font-medium text-[#58a6ff]">
                    {RISKS.length} risks
                  </span>
                </div>
                <Link
              ...
              <div className="divide-y divide-[#30363d]">
                {RISKS.map((risk) => (
                  <div
                    key={risk.id}
                    className={cn(
                      "flex items-center justify-between gap-4 px-5 py-2.5 hover:bg-[#0d1117]/30",
          ...
          <section className="mt-10">
            ...
            <p className="mt-2 text-sm text-[#8b949e]">Continue working in your Diligent applications</p>
            <div className="mt-5 grid gap-3 md:grid-cols-2">
              {RECENT_APPS.map((app) => (
                <a key={app.name} href="#" className="block rounded-2xl border border-[#30363d] bg-[#161b22] px-4 py-3 shadow-sm transition hover:-translate-y-[1px] hover:border-[#58a6ff]/50 hover:bg-[#21262d]">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <span className="text-xs uppercase tracking-[0.2em] text-[#6e7681] opacity-0 group-hover:opacity-100">Open</span>
                  </div>
                </a>
              ))}
            </div>
          ...
          {/* Footer */}
          <footer className="mt-14 border-t border-[#30363d] bg-[#0d1117] px-5 py-5 -mx-6">
            <p className="text-xs uppercase tracking-[0.2em] text-[#6e7681]">System log</p>
            <p className="mt-1 text-sm text-[#8b949e]">Recent system activity (last 24 hours)</p>
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="rounded-2xl border border-[#30363d] bg-[#161b22] p-2 shadow-xl shadow-black/50">
            <div className="flex items-center gap-3">
              ...
              />
              <button type="button" className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#21262d] text-[#484f58] hover:bg-[#30363d] hover:text-[#f0f6fc]">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
